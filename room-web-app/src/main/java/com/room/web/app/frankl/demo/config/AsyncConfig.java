package com.room.web.app.frankl.demo.config;

import com.rabbitmq.client.ConnectionFactory;
import com.room.web.app.frankl.demo.async.RoomCleanerListener;
...
public class AsyncConfig {
    ...
    public Binding binding(Queue queue, TopicExchange exchange){
       return BindingBuilder.bind(queue).to(exchange).with("london.rooms.cleaner");
    }
